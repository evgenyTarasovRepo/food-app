...
public class MenuItemController {
    ...
    public MenuItemDto createMenuItem(@RequestBody @Valid CreateMenuRequest request) {
    ...
    @GetMapping("/{id}")
    public MenuItemDto getMenuItem(@PathVariable("id") @Positive(message = "id должен быть > 0") Long id) {
