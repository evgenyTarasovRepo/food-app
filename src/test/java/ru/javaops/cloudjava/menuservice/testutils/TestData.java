...
import ru.javaops.cloudjava.menuservice.model.Ingredient;
...
public class TestData {
    ...
    public static IngredientCollection italianSaladIngredients() {
        return new IngredientCollection(
                List.of(
                        new Ingredient(ITALIAN_SALAD_GREENS_INGREDIENT, BigDecimal.valueOf(ITALIAN_SALAD_GREENS_INGREDIENT_CALORIES)),
                        new Ingredient(ITALIAN_SALAD_TOMATOES_INGREDIENT, BigDecimal.valueOf(ITALIAN_SALAD_TOMATOES_INGREDIENT_CALORIES))
                )
        );
    }
    ...
    public static UpdateMenuRequest updateMenuBuilder(String name, Double price, Long timeToCook, String description, String imageUrl) {
        return UpdateMenuRequest.builder()
                .name(name)
